...
FINAL FIXED: Propagates technique_id from first event to all events
"""
...
def main():
    ...
    parser.add_argument('--junit', default='regression-results.xml',
                        help='Output path for JUnit report')
    parser.add_argument('--coverage', default='coverage-matrix.csv',
    ...
    # Change to detection-lab directory if needed
    ...
    # Load fixtures
    fixture_path = os.path.join('..', args.fixtures)
